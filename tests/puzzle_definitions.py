...
def MountainLeft4():
    ...
    Ishape3_0 = MultiBlock(
        [(0, 0), (0, 1), (0, 2)], 'Ishape3_0', can_rotate=True)
    Ishape3_1 = MultiBlock([(0, 0), (1, 0), (2, 0)], 'Ishape3_1')
    LShape4 = MultiBlock(
        [(0, 0), (0, 1), (0, 2), (1, 0)], 'LShape4', can_rotate=True)
...
def MountainQuadFloorTopRightSubPuzzle():
    '''Can the LShape piece be solved for? '''
    puzzle_dimensions = Rectangle.get_rectangle(5, 5)
    inner_dimmensions = puzzle_dimensions.grow_upper_right([-1, -1])

    LShapeReverse_upper_right = MultiBlock(
        ((0, 1), (1, 1), (2, 1), (2, 0)), name='LShapeReverse_upper_right')
    VShapeUpRight_upper_right = MultiBlock(
        ((0, 0), (0, 1), (1, 1)), 'VShapeUpRight_upper_right')
    entrance_exit_node_map = {inner_dimmensions.lower_right: 'entrance',
                              inner_dimmensions.upper_left: 'exit'}

    node_to_rule_map = {
        (0, 1): ('shape', LShapeReverse_upper_right),
        #(0, 3): ('shape', VShapeUpRight_upper_right),
    }
    ...
    return puzzle_definition
    # END MountainQuadFloorTopRightSubPuzzle


def MountainQuadFloorTopLeftSubPuzzle():
    ''' Two v pieces'''
    puzzle_dimensions = Rectangle.get_rectangle(5, 5)
    inner_dimmensions = puzzle_dimensions.grow_upper_right([-1, -1])
    ...
    node_to_rule_map = {
        (1, 2): ('shape', VShapeDownLeft_upper_left),
        #(2, 1): ('shape', VShapeDownRight_upper_left),
    }
...
def Bunker7():
    ...
    force_paths = [
        [(0, 0), (0, 1), (1, 1), (1, 0), (2, 0), (3, 0), (3, 1), (4, 1), (4, 2), (3, 2),
         (2, 2), (1, 2), (0, 2), (0, 3), (1, 3), (1, 4), (2, 4), (3, 4), (3, 3), (4, 3), (4, 4)]
    ]
    expected_solutions = [
        [(0, 0), (0, 1), (1, 1), (1, 0), (2, 0), (3, 0), (3, 1), (4, 1), (4, 2), (3, 2),
         (2, 2), (1, 2), (0, 2), (0, 3), (1, 3), (1, 4), (2, 4), (3, 4), (3, 3), (4, 3), (4, 4)]
...
def Bunker8():
    ...
    expected_solutions = [
        [(0, 0), (0, 1), (0, 2), (0, 3), (0, 4), (1, 4), (1, 3), (1, 2), (1, 1), (1, 0), (2, 0), (2, 1), (2, 2),
         (2, 3), (3, 3), (3, 2), (3, 1), (3, 0), (4, 0), (5, 0), (5, 1), (4, 1), (4, 2), (4, 3), (4, 4), (5, 4)]
    ]
